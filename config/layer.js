    ...
    "layers" : [
        {
            ...
            "id": "9d840b27c47545698b62bf22b9150b81",
            "maxzoom": 13.0,
            "source": "Ptstop",
            "layout": {
                "text-size": 12.0,
            ...
            "id": "b6ab725e1de14e45bed4f786831c5360",
            "maxzoom": 17.5,
            "source": "Ptexit",
            "layout": {
                "text-size": 10.0,
            ...
            "id": "fe1cd023a20f4cd18f7a7c3de546a831",
            "maxzoom": 17.5,
            "source": "Annotation",
            "layout": {
                "text-size": 12,
            ...
            "minzoom": 14.0,
            "type": "symbol",
            "filter": ["all", ["==", "kindcode", "180400"], [">=", "rank", 1]]
        }, {
            "id": "46ddf945b5734c80ae2a688f61b1a012",
            "maxzoom": 17.5,
            "source": "Annotation",
            "layout": {
                "text-size": 12.0,
            ...
            "minzoom": 9.0,
            "type": "symbol",
            "filter": ["all", ["==", "kindcode", "230126"], [">=", "rank", 31]]
        }, {
            "id": "97acba333a3f4915a09b691eaaf6d570",
            "maxzoom": 17.5,
            "source": "Annotation",
            "layout": {
                "text-size": 12,
            ...
            "minzoom": 11.0,
            "type": "symbol",
            "filter": ["all", ["==", "kindcode", "180400"], [">=", "rank", 5]]
        }, {
            "id": "7003e741d79747b5b2d51416eed09af8",
            "maxzoom": 17.5,
            "source": "Annotation",
            "layout": {
                "text-size": 12.0,
            ...
            "minzoom": 11.0,
            "type": "symbol",
            "filter": ["all", ["==", "kindcode", "180100"], [">=", "rank", 5]]
        }, {
            "id": "cce2b7e272b44465bcd5f1a578e88f3b",
            "maxzoom": 17.5,
            "source": "Annotation",
            "layout": {
                "text-size": 12.0,
            ...
            "minzoom": 10.0,
            "type": "symbol",
            "filter": ["all", ["==", "kindcode", "170101"], [">=", "rank", 4]]
        }, {
            "id": "19ce94d118264732ab910108c1ed4063",
            "maxzoom": 17.5,
            "source": "Annotation",
            "layout": {
                "text-size": 12,
            ...
            "minzoom": 11.0,
            "type": "symbol",
            "filter": ["all", ["==", "kindcode", "170101"], [">=", "rank", 3]]
        }, {
            "id": "d35c79fb06b44a779d542d1a77db1ade",
            "maxzoom": 17.5,
            "source": "Annotation",
            "layout": {
                "text-size": 12,
            ...
            "minzoom": 12.0,
            "type": "symbol",
            "filter": ["all", ["==", "kindcode", "170101"], [">=", "rank", 1]]
        }, {
            ...
            "id": "154ecb0bbcb34106b6eecc5e6e765586",
            "maxzoom": 17.5,
            "source": "Annotation",
            "layout": {
                "text-size": 12,
            ...
            "minzoom": 12.0,
            "type": "symbol",
            "filter": ["all", ["==", "kindcode", "170102"], [">=", "rank", 1]]
        }, {
            "id": "6afc6ae697124fb08c26271f794b7b60",
            "maxzoom": 17.5,
            "source": "Annotation",
            "layout": {
                "text-size": 12,
            ...
            "id": "c9d4a2426b4341fe84f01ce7d345af99",
            "maxzoom": 17.5,
            "source": "Annotation",
            "layout": {
                "text-size": 12,
            ...
            "id": "8dae11ff4bd64b37a24a18dd85bb0279",
            "maxzoom": 17.5,
            "source": "Annotation",
            "layout": {
                "text-size": 12,
            ...
            "id": "611e83e1daaa4a36a466d8dad59a6f6a",
            "maxzoom": 17.5,
            "source": "Annotation",
            "layout": {
                "text-size": 12,
            ...
            "minzoom": 12,
            "type": "symbol",
            "filter": ["all", ["==", "kindcode", "130102"], [">=", "rank", 1]]
        }, {
            "id": "c3aa40123206463db128ac7a1cbd27f7",
            "maxzoom": 17.5,
            "source": "Annotation",
            "layout": {
                "text-size": 12.0,
            ...
            "minzoom": 10,
            "type": "symbol",
            "filter": ["all", ["==", "kindcode", "160105"], [">=", "rank", 7]]
        }, {
            "id": "48e72ea99e414c56ad920aaef1698071",
            "maxzoom": 17.5,
            "source": "Annotation",
            "layout": {
                "text-size": 12,
            ...
            "minzoom": 13.0,
            "type": "symbol",
            "filter": ["all", ["==", "kindcode", "160103"], [">=", "rank", 3]]
        }, {
            "id": "9ea5bed00df4486082a9f0d0f2372553",
            "maxzoom": 17.5,
            "source": "Annotation",
            "layout": {
                "text-size": 12,
            ...
            "id": "f0f85fc320cd4ddbb32c272f9826d51a",
            "maxzoom": 17.5,
            "source": "Annotation",
            "layout": {
                "text-size": 12,
            ...
            "minzoom": 11.0,
            "type": "symbol",
            "filter": ["all", ["==", "kindcode", "200101"], [">=", "rank", 7]]
        }, {
            ...
            "id": "9a49508509b341c49b5ca89e5b5d63e1",
            "maxzoom": 17.5,
            "source": "Annotation",
            "layout": {
                "text-size": 12,
            ...
            "minzoom": 11,
            "type": "symbol",
            "filter": ["all", ["==", "kindcode", "195126"], [">=", "rank", 3]]
        }, {
            "id": "b9bc8f87461a4448af3cd3b5328f211e",
            "maxzoom": 17.5,
            "source": "Annotation",
            "layout": {
                "text-size": 12.0,
            ...
            "minzoom": 10,
            "type": "symbol",
            "filter": ["all", ["==", "kindcode", "230103"], [">=", "rank", 15]]
        }, {
            "id": "57ad050f809d4637a124cd44fcd9a67a",
            "maxzoom": 17.5,
            "source": "Annotation",
            "layout": {
                "text-size": 12,
            ...
            "minzoom": 12.0,
            "type": "symbol",
            "filter": ["all", ["==", "kindcode", "180304"], [">=", "rank", 7]]
        }, {
            "id": "e678110402044c619d179945fc788494",
            "maxzoom": 17.5,
            "source": "Annotation",
            "layout": {
                "text-size": 12,
            ...
            "minzoom": 10,
            "type": "symbol",
            "filter": ["all", ["==", "kindcode", "180304"], [">=", "rank", 15]]
        }, {
